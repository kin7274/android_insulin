...
public class SettingActivity2 extends AppCompatActivity implements OnClickListener, OnItemSelectedListener, SettingRecyclerAdapter.SettingRecyclerViewClickListener {
        ...
        spinner01.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (spinner01.getItemAtPosition(position) == getResources().getString(R.string.insulin_name)) {
                    ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(SettingActivity2.this, android.R.layout.simple_spinner_item, items1);
                    ...
                    ArrayAdapter<String> adapter3 = new ArrayAdapter<String>(SettingActivity2.this, android.R.layout.simple_spinner_item, items2);
                    ...
                    ArrayAdapter<String> adapter4 = new ArrayAdapter<String>(SettingActivity2.this, android.R.layout.simple_spinner_item, items3);
                    ...
                    ArrayAdapter<String> adapter5 = new ArrayAdapter<String>(SettingActivity2.this, android.R.layout.simple_spinner_item, items4);
                    ...
                    ArrayAdapter<String> adapter6 = new ArrayAdapter<String>(SettingActivity2.this, android.R.layout.simple_spinner_item, items5);
        ...
        switch (view.getId()) {
            ...
            case R.id.abc_dec:
                ...
                if (inabc == 1) {
                    ...
                    Toast.makeText(SettingActivity2.this, getResources().getString(R.string.num_limit), Toast.LENGTH_SHORT).show();
                } else {
                    // 음수 아니면 원래대로 감소
                    inabc--;
                    abc_num.setText(String.valueOf(inabc));
                ...
                builder.setTitle("최종 확인")
                        ...
                        .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                String BB = a1 + ", " + a2 + ", " + a3 + ", " + a4;
                                Intent returnIntent = new Intent();
                                returnIntent.putExtra("BB", BB);
